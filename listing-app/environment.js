...
const ENV = {
  development: {
    GRAPHQL_URL: 'http://192.168.100.105:8003/graphql',
    WS_GRAPHQL_URL: 'ws://192.168.100.105:8003/graphql',
    SERVER_URL: 'http://192.168.100.105:8003/', // put / at the end of server url
